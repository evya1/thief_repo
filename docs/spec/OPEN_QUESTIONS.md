...
**Convention.** Two scent profiles are implemented behind one common interface, recorded in full in `planning/mechanisms/M-01-scent-model.md` §B and selected through `ADR-004`:
